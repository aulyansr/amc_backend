var colors = ["#727cf5", "#0acf97", "#fa5c7c"],
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#datalabels-column"), options)).render(), ["#39afd1", "#ffbc00", "#e3eaef"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#stacked-column"), options)).render(), ["#39afd1", "#0acf97", "#e3eaef"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#full-stacked-column"), options)).render(), ["#0acf97", "#fa5c7c"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#column-with-markers"), options)).render(), ["#0acf97", "#fa5c7c"]),
    optionsGroup =
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#rotate-labels-column"), options)).render(), ["#727cf5"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#negative-value-column"), options)).render(), ["#727cf5", "#6c757d", "#0acf97", "#fa5c7c", "#ffbc00", "#39afd1", "#e3eaef", "#313a46"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#distributed-column"), options)).render(), ["#0acf97", "#39afd1"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#range-column"), options)).render(), ["#727cf5", "#6c757d", "#0acf97", "#fa5c7c", "#ffbc00", "#39afd1", "#e3eaef", "#313a46"]);
...
function updateQuarterChart(t, o) {
    ...
    if (t.w.globals.selectedDataPoints[0]) {
        ...
        return 0 === a.length && (a = [{ data: [] }]), ApexCharts.exec(o, "updateOptions", { series: a, colors: e, fill: { colors: e } });
    }
}
var options = {
