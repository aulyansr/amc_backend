var colors = ["#727cf5", "#6c757d", "#0acf97", "#fa5c7c", "#e3eaef"],
    ...
    colors = (chart.render(), ["#39afd1", "#ffbc00", "#313a46", "#fa5c7c", "#0acf97"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#monochrome-pie"), options)).render(), ["#727cf5", "#6c757d", "#0acf97", "#fa5c7c", "#e3eaef"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#gradient-donut"), options)).render(), ["#39afd1", "#ffbc00", "#313a46", "#fa5c7c", "#0acf97"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#patterned-donut"), options)).render(), ["#39afd1", "#ffbc00", "#727cf5", "#0acf97"]),
    ...
    colors = ((chart = new ApexCharts(document.querySelector("#image-pie"), options)).render(), ["#727cf5", "#6c757d", "#0acf97", "#fa5c7c"]),
