...
@section('content')
    ...
    <div class="container" id="terms">
        <div class="my-5">
            ...
            <p>
                Welcome to <b>AMC</b>. <b>AMC</b> ("us", "we", or "our") operates <b>acmaintenance.id</b>(here in
                after
                referred to as <b>"Service"</b>). Our Privacy Policy governs your visit to <b>acmaintenance.id</b>, and
                explains
                how we
                collect, safeguard and disclose information that results from your use of our Service. We use your data to
                provide and improve Service. By using Service, you agree to the collection and use of information in
                accordance with this
                policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same
                meanings as in our Terms and Conditions. Our Terms and Conditions (<b>"Terms"</b>) govern all use of our
                Service and
                together with the Privacy Policy constitutes your agreement with us (<b>"agreement"</b>).
            </p>
            <h2>2. Definitions</h2>
            <p>
                SERVICE means the acmaintenance.id website operated by AMC. PERSONAL DATA means data about a living
                individual who can be identified from those data (or from those and other information either in our
                possession or likely to come
                into our possession). USAGE DATA is data collected automatically either generated by the use of Service or
                from Service infrastructure itself (for example, the duration of a page visit). COOKIES are small files
                stored on your
                device (computer or mobile device). DATA CONTROLLER means a natural or legal person who (either alone or
                jointly or in common with other persons) determines the purposes for which and the manner in which any
                personal data are,
                or are to be, processed. For the purpose of this Privacy Policy, we are a Data Controller of your data. DATA
                PROCESSORS (OR SERVICE PROVIDERS) means any natural or legal person who processes the data on behalf of the
                Data
                Controller. We may use the services of various Service Providers in order to process your data more
                effectively. DATA SUBJECT is any living individual who is the subject of Personal Data. THE USER is the
                individual using our
            ...
            <p>
                ...
                0.3. Gender <br />
                0.4. Date of Birth <br>
                0.5. Phone number <br />
                0.6. Address, Country, State, Province, ZIP/Postal code, City <br />
                0.7. Cookies and Usage Data<br />
            ...
            <p>
                ...
                time spent
                on those pages, unique device identifiers and other diagnostic data.<br />
            ...
            <p>
                ...
                such as
                beacons, tags and scripts to collect and track information and to improve and analyze our Service.<br />
            ...
            <p>
                ...
                agreements, information on bonuses and compensation, information on marital status, family members, social
                security (or
                other taxpayer identification) number, office location and other data.
            </p>
            <h2>5. Use of Data</h2>
            <p>
                AMC uses the collected data for various purposes:<br />
                ...
                0.12. in any other way we may describe when you provide the information; 0.13. for any other purpose with
                your consent.
            </p>
            ...
            <p>
                ...
                If you are located outside Indonesia and choose to provide information to us, please note that we transfer
                the data, including Personal Data, to Indonesia and process it there.<br />
                Your consent to this Privacy Policy followed by your submission of such information represents your
                agreement to that transfer.<br />
                AMC will take all the steps reasonably necessary to ensure that your data is treated securely and in
            ...
            <p>
                ...
                0.3.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of
            ...
            <p>
                ...
                protection rights, covered by GDPR.<br />
                ...
                systems, please email us at hello@acmaintenance.id.<br />
                ...
                0.2. the right of rectification. You have the right to have your information rectified if that information
            ...
            <p>
                ...
                collected and those
                individuals with whom it is being shared, and to comply with this policy.<br />
                ...
                0.4. users are able to change their personal information by emailing us at hello@acmaintenance.id.<br />
            ...
            <h3>0.1. What personal information we have about you. If you make this request, we will return to you:</h3>
            <p>
                ...
                company we sold it to. If we have not sold your personal information, we will inform you of that fact.<br />
                0.0.7. A list of categories of personal information that we have disclosed for a business purpose, along
                with the category of any other company we shared it with.<br />
            ...
            <h3>
                ...
                same. In
                some cases, deletion may be accomplished through de-identification of the information. If you choose to
                delete
            </h3>
            <h3>your personal information, you may not be able to use certain functions that require your personal
                information to operate.</h3>
            <h3>
                ...
                some
                circumstances, a transfer of personal information to a third party, or within our family of companies,
            ...
            <p>
                ...
                Service on our behalf, perform Service-related services or assist us in analysing how our Service is
                used.<br />
            ...
            <p>
                ...
                high-quality legal documents. PolicyMaker’s privacy policy generator is an easy-to-use tool for creating a
                privacy policy
            ...
            <p>
                ...
                collected Personal
                Data from Children without verification of parental consent, we take steps to remove that information from
                our servers.
            </p>
            ...
            <p>
                ...
                effective and update “effective date” at the top of this Privacy Policy.<br />
                You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy
                are effective when they are posted on this page.
            </p>
            <h2>21. Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us by email: hello@acmaintenance.id.</p>
        </div>
    </div>
@endsection
@section('js')
