                    ...
                    <div class="card rounded-5 border-0 shadow">
                        <div class="card-body">
                            <div class="p-2 p-lg-5 text-center">
                                ...
                                <p>Untuk kemudahan dalam pengecekan pesanan, pastikan nomor Handphone Anda sudah
                                    diverifikasi.</p>
                                @if ($errors->any())
                                ...
                                @endif
                                <form class="my-3" method="POST" action="{{ route('customer.otp', $hashedId) }}">
                                    @csrf
                                    <button type="submit" class="btn btn-dark-blue ">Kirim SMS ke
