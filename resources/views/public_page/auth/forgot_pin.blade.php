                    ...
                    <div class="card rounded-5 border-0 shadow">
                        <div class="card-body">
                            <div class="p-2 p-lg-5 text-center">
                                ...
                                @endif
                                <form class="my-3" method="POST" action="{{ route('customer.forgot.send_forgot') }}">
                                    @csrf
                                    <div class="mb-3">
                                        {{ Form::text('no_hp', null, ['class' => 'form-control', 'onkeyup' => 'return isNumber(event)']) }}
                                    </div>
                                    <button type="submit" class="btn btn-dark-blue ">Kirim Link Lupa Pin Ke
                                        SMS</button>
                                </form>
