...
<body>
            ...
            <div class="col-md-6">
                <div class="hv-100 d-flex align-items-center justify-content-center">
                    <div class="p-2 p-lg-5">
                        ...
                        <h1 class="text-primary-blue">Login Sekarang</h1>
                        <p>Belum Punya akun? <a href="{{ route('customer.register') }}"
                                class="text-primary-blue">Register</a></p>
                        <form class="mb-3" method="POST" action="{{ route('customer.login') }}">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="phone" pattern="[0-9]+" min="10"
                                    title="Nomor HP Harus angka dengan minimal 10 digit" class="form-control"
                                    id="phone_number" aria-describedby="phoneHelp">
                            </div>
                            <div class="mb-1">
                            ...
                            <div class="mb-3 text-end">
                                <a href="{{ route('customer.forgot.index') }}" class="text-primary-blue">Lupa PIN ?</a>
                            </div>
                            <button type="submit" class="btn btn-dark-blue ">Log in</button>
                        </form>
    ...
    <!-- Check if the 'success' message is defined in the session -->
    @if (session('success'))
