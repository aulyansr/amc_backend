...
@section('content')
    ...
    <div class="container" id="terms">
        <div class="my-5">
            ...
            <p style="margin-bottom: 28px">Effective date: 2024-04-01</p>
            <h2>1. Introduction</h2>
            <p>
                Welcome to <b>AMC</b>. <b>AMC</b> ("us", "we", or "our") operates
                <b>acmaintenance.id</b>(here in after referred to as <b>"Service"</b>). Our
                Privacy Policy governs your visit to <b>acmaintenance.id</b>, and explains how
                we collect, safeguard and disclose information that results from your use
                of our Service. We use your data to provide and improve Service. By using
                ...
                and Conditions. Our Terms and Conditions (<b>"Terms"</b>) govern all use
                of our Service and together with the Privacy Policy constitutes your
                agreement with us (<b>"agreement"</b>).
            </p>
            <h2>2. Definitions</h2>
            <p>
                SERVICE means the acmaintenance.id website operated by AMC. PERSONAL DATA
                means data about a living individual who can be identified from those data
                (or from those and other information either in our possession or likely to
                come into our possession). USAGE DATA is data collected automatically
                either generated by the use of Service or from Service infrastructure
                itself (for example, the duration of a page visit). COOKIES are small
                files stored on your device (computer or mobile device). DATA CONTROLLER
                ...
                PROCESSORS (OR SERVICE PROVIDERS) means any natural or legal person who
            ...
            <p>
                ...
                include, but is not limited to:<br />0.1. Email address <br />0.2. First
                name and last name <br />0.3. Phone number <br />0.4. Address, Country,
                State, Province, ZIP/Postal code, City <br />0.5. Cookies and Usage
                Data<br />We may use your Personal Data to contact you with newsletters,
            ...
            <p>
                ...
                Data”).<br />This Usage Data may include information such as your
                computer’s Internet Protocol address (e.g. IP address), browser type,
                browser version, the pages of our Service that you visit, the time and
                date of your visit, the time spent on those pages, unique device
                identifiers and other diagnostic data.<br />When you access Service with a
                device, this Usage Data may include information such as the type of device
                you use, your device unique ID, the IP address of your device, your device
            ...
            <p>
                ...
                features of our Service, to improve and customize our Service.<br />You
                can enable or disable location services when you use our Service at any
                time by way of your device settings.
            </p>
            <h3>Tracking Cookies Data</h3>
            <p>
                We use cookies and similar tracking technologies to track the activity on
                our Service and we hold certain information.<br />Cookies are files with a
                ...
                Service.<br />You can instruct your browser to refuse all cookies or to
                indicate when a cookie is being sent. However, if you do not accept
                cookies, you may not be able to use some portions of our Service.<br />Examples
                of Cookies we use:<br />0.1. Session Cookies: We use Session Cookies to
                operate our Service.<br />0.2. Preference Cookies: We use Preference
                Cookies to remember your preferences and various settings.<br />0.3.
                Security Cookies: We use Security Cookies for security purposes.<br />0.4.
            ...
            <p>
                ...
                professional training, employment agreements, NDA agreements, information
            ...
            <h2>5. Use of Data</h2>
            <p>
                AMC uses the collected data for various purposes:<br />0.1. to provide
                and maintain our Service;<br />0.2. to notify you about changes to our
                Service; <br />0.3. to allow you to participate in interactive features of
                our Service when you choose to do so;<br />0.4. to provide customer
                support;<br />0.5. to gather analysis or valuable information so that we
                can improve our Service;<br />0.6. to monitor the usage of our Service;<br />0.7.
                to detect, prevent and address technical issues;<br />0.8. to fulfil any
                other purpose for which you provide it;<br />0.9. to carry out our
                obligations and enforce our rights arising from any contracts entered into
                between you and us, including for billing and collection;<br />0.10. to
                provide you with notices about your account and/or subscription, including
                expiration and renewal notices, email-instructions, etc.;<br />0.11. to
                ...
                receive such information;<br />0.12. in any other way we may describe when
                you provide the information; 0.13. for any other purpose with your
                consent.
            </p>
            ...
            <p>
                ...
                policies. <br />We will also retain Usage Data for internal analysis
                purposes. Usage Data is generally retained for a shorter period, except
            ...
            <p>
                ...
                differ from those of your jurisdiction.<br />If you are located outside
                Indonesia and choose to provide information to us, please note that we
                transfer the data, including Personal Data, to Indonesia and process it
                there.<br />Your consent to this Privacy Policy followed by your
                submission of such information represents your agreement to that
                transfer.<br />AMC will take all the steps reasonably necessary to
            ...
            <p>
                0.3.1. to our subsidiaries and affiliates;<br />0.3.2. to contractors,
                service providers, and other third parties we use to support our
                business;<br />0.3.3. to fulfill the purpose for which you provide it;<br />0.3.4.
                for the purpose of including your company’s logo on our website;<br />0.3.5.
                for any other purpose disclosed by us when you provide the information;<br />0.3.6.
                with your consent in any other cases;<br />0.3.7. if we believe disclosure
                is necessary or appropriate to protect the rights, property, or safety of
            ...
            <p>
                ...
                Area (EEA), you have certain data protection rights, covered by GDPR.<br />We
                aim to take reasonable steps to allow you to correct, amend, delete, or
                limit the use of your Personal Data.<br />If you wish to be informed what
                Personal Data we hold about you and if you want it to be removed from our
                systems, please email us at hello@acmaintenance.id.<br />In certain circumstances,
                you have the following data protection rights:<br />0.1. the right to
                access, update or to delete the information we have on you;<br />0.2. the
                right of rectification. You have the right to have your information
                rectified if that information is inaccurate or incomplete;<br />0.3. the
                right to object. You have the right to object to our processing of your
                Personal Data;<br />0.4. the right of restriction. You have the right to
                request that we restrict the processing of your personal information;<br />0.5.
                ...
                used format;<br />0.6. the right to withdraw consent. You also have the
                right to withdraw your consent at any time where we rely on your consent
                to process your personal information;<br />Please note that we may ask you
                to verify your identity before responding to such requests. Please note,
                we may not able to provide Service without some necessary data.<br />You
            ...
            <p>
                ...
                shared, and to comply with this policy.<br />According to CalOPPA we agree
                to the following:<br />0.1. users can visit our site anonymously;<br />0.2.
                our Privacy Policy link includes the word “Privacy”, and can easily be
                found on the home page of our website;<br />0.3. users will be notified of
                any privacy policy changes on our Privacy Policy Page;<br />0.4. users are
                able to change their personal information by emailing us at
                hello@acmaintenance.id.<br />Our Policy on “Do Not Track” Signals:<br />We honor Do
                Not Track signals and do not track, plant cookies, or use advertising when
                a Do Not Track browser mechanism is in place. Do Not Track is a preference
                you can set in your web browser to inform websites that you do not want to
                be tracked.<br />You can enable or disable Do Not Track by visiting the
            ...
            <p>
                ...
                you.<br />0.0.2. The categories of sources from which we collect your
                personal information.<br />0.0.3. The business or commercial purpose for
                collecting or selling your personal information.<br />0.0.4. The
                categories of third parties with whom we share personal information.<br />0.0.5.
                The specific pieces of personal information we have collected about
                you.<br />0.0.6. A list of categories of personal information that we have
                sold, along with the category of any other company we sold it to. If we
                have not sold your personal information, we will inform you of that
                fact.<br />0.0.7. A list of categories of personal information that we
                have disclosed for a business purpose, along with the category of any
                other company we shared it with.<br />Please note, you are entitled to ask
                us to provide you with this information up to two times in a rolling
                twelve-month period. When you make this request, the information provided
                may be limited to the personal information we collected about you in the
                previous 12 months.
            </p>
            <h3>
            ...
            <p>
                ...
                stop making such transfers.<br />Please note, if you ask us to delete or
                stop selling your data, it may impact your experience with us, and you may
                not be able to participate in certain programs or membership services
                ...
                rights.<br />To exercise your California data protection rights described
                above, please send your request(s) by email: hello@acmaintenance.id.<br />Your data
            ...
            <p>
                ...
                used.<br />These third parties have access to your Personal Data only to
            ...
            <p>
                ...
                processors).<br />We will not store or collect your payment card details.
                ...
                PCI-DSS as managed by the PCI Security Standards Council, which is a joint
            ...
            <p>
                ...
                site you visit.<br />We have no control over and assume no responsibility
                for the content, privacy policies or practices of any third party sites or
                services.<br />For example, the outlined privacy policy has been made
                using PolicyMaker.io, a free tool that helps create high-quality legal
            ...
            <p>
                ...
                (“Child” or “Children”).<br />We do not knowingly collect personally
            ...
            <p>
                ...
                any changes by posting the new Privacy Policy on this page.<br />We will
                ...
                this Privacy Policy.<br />You are advised to review this Privacy Policy
