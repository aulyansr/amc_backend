            ...
            <div class="row gy-3">
                <div class="col-12">
                    <div class="d-flex justify-content-between mb-3">
                        <p class="text-primary-blue mb-0 fw-bold fs-5">Foto Setelah Pengerjaan</p>
                    ...
                    <div class="row g-3">
                        @foreach ($order_ac as $o)
                            ...
                            @if (!empty($o->activitiesServices))
                                @foreach ($o->activitiesServices->where('row_count', '>', 1) as $as)
                                    <div class="col-6">
                                        <p class="text-primary-blue mb-3">{{ $as->title }}</p>
                                        <div class="card card-homepage mb-3">
                                            <div class="card-body">
                                                <form
                                                    action="{{ route('technician.store_image_after', [$o->id, $as->id]) }}"
