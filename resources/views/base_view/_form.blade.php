<div class="row g-3">
    <div class="col-lg-6 col-12">
        <div class="form-group">
            ...
            {!! Form::select('customer', $customer->pluck('nama', 'id'), old('customer') ?? $masterac->master_customer_id, ['placeholder' => 'Pilih Customer', 'class' => 'form-control select2 ','required', 'id'=>'customer']) !!}
        </div>
    </div>
    <div class="col-lg-6 col-12">
        <div class="form-group">
    ...
    <div class="col-lg-6 col-12">
        <div class="form-group">
            ...
            {!! Form::text('ac_category', old('ac_category') ?? $masterac->ac_category , ['placeholder' => 'Ac Category', 'class' => 'form-control ','required', 'id'=>'ac_category']) !!}
        </div>
    </div>
    <div class="col-lg-6 col-12">
        <div class="form-group">
            <label for="room_name">Nama Ruangan</label>
            {!! Form::text('room_name', old('room_name') ?? $masterac->room_name , ['placeholder' => 'Nama Ruangan', 'class' => 'form-control ','required', 'id'=>'room_name']) !!}
        </div>
    </div>
    <div class="col-12">
        <div class="row">
