...
@section('title', 'Create Service Children')
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">New Service Children</h3>
                        </div>
                        <div class="card-body">
                            {!! Form::open([
                                'route' => ['master.services.service_children.store', $service->id],
                                'method' => 'POST',
                                'enctype' => 'multipart/form-data',
                            ]) !!}
                            <div class="row g-3">
                                @include('service_children._form', [
                                    'submit' => 'Simpan',
                                ])
